...
@ApiModel(value="组织新增", description="组织管理")
public class OrganizationInsertVo {
    ...
    @ApiModelProperty(value = "来源 1 后台管理员添加 2 自己注册", required = true)
    ...
    @ApiModelProperty(value = "企业注册号", required = true)
    @NotBlank(message = "企业注册号不能为空")
    private String entRegno;

    @ApiModelProperty(value = "企业营业执照地址", required = true)
    @NotBlank(message = "企业营业执照地址不能为空")
    ...
    @ApiModelProperty(value = "法人介绍地址", required = true)
    @NotBlank(message = "法人介绍地址不能为空")
    private String legalPersonUrl;

    @ApiModelProperty(value = "法人身份证正面地址", required = true)
    @NotBlank(message = "法人身份证正面地址不能为空")
    private String legalPersonCardNurl;

    @ApiModelProperty(value = "法人身份证反面地址", required = true)
    @NotBlank(message = "法人身份证反面地址不能为空")
